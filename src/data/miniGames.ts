...
export const SPOT_DIFF_SCENES: SpotDiffScene[] = [
  {
    ...
    aspect: 1408 / 768,
    diffs: [
      { x: 33, y: 12, hint: "Balão no céu" },
      { x: 80, y: 13, hint: "Pássaros voando" },
      { x: 88, y: 43, hint: "Helicóptero" },
      { x: 57, y: 13, hint: "Nuvem rosada" },
      { x: 16, y: 30, hint: "Cor da túnica do Cristo" },
      { x: 32, y: 92, hint: "Flor vermelha" },
      { x: 95, y: 80, hint: "Rocha à direita" },
    ],
  },
  {
    id: "eiffel",
    ...
    aspect: 1024 / 768,
    diffs: [
      { x: 12, y: 17, hint: "Nuvem rosa" },
      { x: 85, y: 17, hint: "Balão amarelo" },
      { x: 50, y: 5, hint: "Bandeira no topo" },
      { x: 13, y: 38, hint: "Pássaro laranja" },
      { x: 10, y: 88, hint: "Banco vermelho" },
      { x: 48, y: 80, hint: "Pessoa de azul" },
      { x: 75, y: 88, hint: "Caminho à direita" },
    ],
  },
  {
    id: "coliseu",
    ...
    aspect: 1024 / 768,
    diffs: [
      { x: 22, y: 16, hint: "Pássaros no céu" },
      { x: 50, y: 10, hint: "Avião" },
      { x: 85, y: 16, hint: "Balão listrado" },
      { x: 52, y: 45, hint: "Arco fechado com tijolos" },
      { x: 58, y: 62, hint: "Porta de tijolos avermelhados" },
      { x: 25, y: 85, hint: "Vespa vermelha" },
      { x: 85, y: 78, hint: "Guarda-chuva amarelo" },
    ],
  },
];
